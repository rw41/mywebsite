...
After completing my previous project on large factor models, I developed a strong interest in adaptive regularization techniques, especially within the context of network analysis. I am currently exploring advanced methods such as nonconvex penalties and Bayesian approaches (e.g., the Bayesian lasso), where Bayesian methods (especially prior and posterior checks) can make regularization models even more self-adaptive.
