...
## Adaptive Regularization in Complex Data

After completing my previous project on large factor models, I developed a strong interest in adaptive regularization techniques, especially within the context of network analysis.  I was specifically interested in the high-dimensional scenario, especially when $p > n$. In this case, $X^\top X$ becomes non-invertible, which makes ordinary least squares estimation unstable and prone to overfitting. I am currently exploring advanced methods such as nonconvex penalties and Bayesian approaches (e.g., the Bayesian lasso), where Bayesian methods (especially prior and posterior checks) can make regularization models even more self-adaptive.My ability in this area is supported by the training I received in **[STAT 431 (Applied Bayesian Analysis)](https://courses.illinois.edu/schedule/2025/fall/STAT/431)** and **[STAT 432 (Basics of Statistical Learning)](https://teazrq.github.io/stat432/)**, which has laid the foundation for my current exploration of adaptive regularization methods.
